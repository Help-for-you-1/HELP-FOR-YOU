...
async function fixTotalLoanOnly(){
 ...
 const allLoans=lr.data||[],cs=cr.data||[],es=er.data||[],apps=ar.data||[];const loans=allLoans.filter(l=>String(l.loan_status||'').toLowerCase()!=='completed');window.__emiLoanRows=loans;
 let dashboardDue=0;
